...
contract CounterTest is Test, Fixtures {
    ...
    function est_mintLiquidity() public {
    ...
    function est_mintLiquidityNative() public {
        uint256 liquidityToMint = 100e18;
        address recipient = address(this);
    ...
    function est_increaseLiquidity() public {
    ...
    function est_increaseLiquidityNative() public {
        uint256 liquidityToMint = 100e18;
        address recipient = address(this);
    ...
    function est_decreaseLiquidity() public {
        (uint256 tokenId,) = posm.mint(
            key,
            tickLower,
            tickUpper,
